...
export const styles = StyleSheet.create({
  ...
  checkoutModal: { flex: 1, backgroundColor: colors.background },
  checkoutHeader: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  checkoutTitle: { color: colors.textPrimary, fontSize: 16, fontWeight: '700' },
  checkoutClose: { padding: spacing.sm },
  checkoutCloseText: { color: colors.textMuted, fontSize: 18 },
  checkoutWebView: { flex: 1, backgroundColor: colors.background },
  checkoutLoading: { marginTop: spacing.xxl },
});